...
CREATE TABLE documents (
    ...
    total_words             INTEGER, -- Total word count of the document
    summary                 TEXT, -- Document summary
    summary_word_count      INTEGER, -- Word count of the summary
    compression_ratio       FLOAT, -- Compression ratio of the summary
    tier                    INTEGER, -- Summarization tier used
...
-- =======================
-- 1.3 look-up tables form and responsible body
-- =======================
CREATE TABLE forms (
...
CREATE INDEX idx_documents_celex ON documents(celex_number);
